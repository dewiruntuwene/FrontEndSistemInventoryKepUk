<template>
  ...
  <div class="mt-0 pl-[15rem] pr-4">
    <div
      class="border-y-0 border-b-0 bg-white-200 bg-slate-300 flex flex-row justify-between items-center p-5 pl-5"
    >
            ...
            >
              ...
              <td class="py-2 px-4 text-left border">
                <img
                  ...
                  :src="`http://localhost:5000/uploads/${item.gambar_barang}`"
                  alt="Gambar Barang"
