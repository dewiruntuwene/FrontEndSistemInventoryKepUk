...
<template>
  <div class="mx-auto max-w-1400 h-1531">
    <div class="sm:flex sm:w-full flex-col p-4">
      <!-- Header -->
      <div
        class="lg:left-0 left-[-200px] fixed top-0 z-50 w-full pl-60 flex items-center justify-between bg-slate-200 p-5"
      >
        <div class="flex space-x-5">
          <button
            class="lg:hidden flex cursor pointer inline-block rounded bg-blue-600 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg"
            onclick="Open()"
          ...
          <div class="md:w-32 lg:w-48">
            <input
              type="text"
              class="w-96 rounded-full pl-3 py-1"
              placeholder="Search"
            />
          </div>
        </div>
        ...
        <div class="py-2 flex space-x-3">
          ...
          <div class="flex-row">
            <router-link to="/logout">
              <a
                href="#"
                class="inline-block text-sm px-4 py-2 leading-none border-black rounded text-black border-white hover:border-transparent hover:text-natural-900 hover:bg-white mt-4 lg:mt-0"
                >Logout</a
              >
            </router-link>
          </div>
