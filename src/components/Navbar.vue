              ...
              <div class="p-4">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="bg-white p-2 rounded-md shadow-md flex flex-col space-y-2">
                    ...
                    <li>
                      <button class="text-blue-500 hover:underline" @click="logout">Logout</button>
                    </li>
                  </ol>
                </nav>
              </div>
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <div class="flex-row relative">
                  <a href="#" class=" inline-block text-sm px-4 py-2 leading-none border-black rounded text-black border-white hover:border-transparent hover:text-natural-900 hover:bg-blue mt-4 lg:mt-0" @click="logout">Logout</a>
                </div>
              </div>
            </div>
